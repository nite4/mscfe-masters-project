...
def moving_average_convergence_divergence(series:pd.Series, ticker:str,
...
def relative_strength_index(series:pd.Series, ticker:str, timeperiod:int=14):
    '''
...
def bollinger_bands(series:pd.Series, ticker:str,
                    timeperiod:int=20, nbdevup:int=2, nbdevdn:int=2):
    '''
...
def stochastic_oscillator(high:pd.Series, low:pd.Series, close:pd.Series,
                          ticker:str, fastk_period:int=14, slowk_period:int=3,
                          slowd_period:int=3):
    '''
...
def calculate_spread(close:pd.Series, return_dataframe:bool=False):
    '''
...
def create_features(ticker_eqt:str, ticker_cpy:str, df_equity:pd.DataFrame,
                    df_crypto:pd.DataFrame, config:dict, dropna:bool=False):
    '''
